...
# Bot information
SESSION = environ.get('SESSION', 'ipap')
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002045874654 -1001918999034').split()]
...
REQUEST_TO_JOIN_MODE = bool(environ.get('REQUEST_TO_JOIN_MODE', 1)) # Set True Or False
TRY_AGAIN_BTN = bool(environ.get('TRY_AGAIN_BTN', False)) # Set True Or False
auth_channel = environ.get('AUTH_CHANNEL', '-1001932915263') # give your force subscribe channel id here else leave it blank
...
PREMIUM_AND_REFERAL_MODE = bool(environ.get('PREMIUM_AND_REFERAL_MODE', 0)) # Set Ture Or False
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'presood') # owner username without @

# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/ipapcornnew')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/EpicCinemanearme')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/EpicCinemanearme')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'ipapcorn_support') # Support Chat Link Without https:// or @

# True Or False
AI_SPELL_CHECK = bool(environ.get('AI_SPELL_CHECK', True))
PM_SEARCH = bool(environ.get('PM_SEARCH', 0))
IS_SHORTLINK = bool(environ.get('IS_SHORTLINK', 0))
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', 0))
...
# Shortlink Info
SHORTLINK_MODE = bool(environ.get('SHORTLINK_MODE', 0))
...
STREAM_MODE = bool(environ.get('STREAM_MODE', 0)) # Set True or False
